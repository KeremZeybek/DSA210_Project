...
- [ ] **Phase 3: Machine Learning (Target: Jan 02)**
  - [ ] **Feature Engineering:** Create lagged target variables ($t+1$) for prediction.
  - [ ] **Modeling:** Train a Random Forest Regressor to predict future repression events.
  - [ ] **Evaluation:** Analyze R² scores and Feature Importance (Stringency vs. Economy).

- [ ] **Phase 4: Final Reporting (Target: Jan 09)**
  - [ ] Finalize code documentation and comments.
  - [ ] Complete `README.md` with ML results.
  - [ ] Final Submission.
...
**HYPOTHESIS TEST RESULT:** SUPPORTED. > Our statistical analysis confirmed a significant positive correlation (p<0.05). Furthermore, the correlation was found to be even stronger at Lag 0 (same month) than the subsequent month.
...
**Usage Areas:**
1.  **Code Optimization:** AI was used to debug Pandas merging errors and optimize the "Lag Analysis" loops for better performance.
2.  **Visualization:** Matplotlib and Seaborn code snippets for the "Risk Map" (Bubble Chart) and "Rolling Correlation" were generated with AI assistance.
3.  **Statistical Interpretation:** AI helped in interpreting the results of the Spearman Correlation and T-Tests to ensure accurate statistical language.
